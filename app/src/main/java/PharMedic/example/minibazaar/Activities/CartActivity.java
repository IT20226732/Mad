package PharMedic.example.minibazaar.Activities;
...
import PharMedic.example.minibazaar.Models.SingleProductModel;
import PharMedic.example.minibazaar.NetworkSync.CheckInternetConnection;
import com.example.minibazaar.R;
import PharMedic.example.minibazaar.UserSession.UserSession;
...
public class CartActivity extends AppCompatActivity {
    ...
    private void populateRecyclerView() {
        ...
        adapter =new FirestoreRecyclerAdapter<SingleProductModel, CartActivity.MovieViewHolder>(response) {
            @Override
            protected void onBindViewHolder(@NonNull CartActivity.MovieViewHolder viewHolder, @SuppressLint("RecyclerView") final int position, @NonNull SingleProductModel model) {
